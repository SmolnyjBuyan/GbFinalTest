...
public class DataBase {
    ...
    private static final Map<AnimalType, DataBaseInsert<Animal>> INSERT_PATH = Map.of(
            AnimalType.CAT, DataBase::insertIntoCats,
            AnimalType.DOG, DataBase::insertIntoDogs,
            AnimalType.HAMSTER, DataBase::insertIntoHamsters
    );
    ...
    public void insert(Animal animal) throws SQLException {
        INSERT_PATH.get(animal.getPetType()).insert(animal);
    }
    ...
    private static PreparedStatement getInsertIntoPetsStatement(Animal pet) throws SQLException {
        ...
        statement.setString(NAME_COLUMN_INDEX, pet.getName());
        statement.setObject(BIRTH_DATE_COLUMN_INDEX, pet.getBirthDate());
        statement.setString(GENDER_COLUMN_INDEX, pet.getGender().getTitle());
        statement.setInt(TYPE_COLUMN_INDEX, pet.getPetType().getId());
        return statement;
    }
    ...
    @FunctionalInterface
    private interface DataBaseInsert<Animal> {
        void insert(Animal animal) throws SQLException;
    }
}
